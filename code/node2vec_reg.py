#################################################################
# Modified version of layer/node2vec.py from Stellargraph
...
class Node2VecReg:
    ...
    def __init__(self, emb_size, generator=None, node_num=None, multiplicity=None, reg_weight=0.0):
        ...
        self.target_embedding = Embedding(
            ...
            self.emb_size,
            input_length=1,
            embeddings_regularizer=keras.regularizers.l2(self.reg_weight),
